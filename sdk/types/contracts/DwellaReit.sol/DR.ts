...
export interface DRInterface extends utils.Interface {
  functions: {
    "ADMIN_ROLE()": FunctionFragment;
    "DEFAULT_ADMIN_ROLE()": FunctionFragment;
    "MINTER_ROLE()": FunctionFragment;
    "MODERATOR()": FunctionFragment;
    "__DR_init(address)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "__DR_init", data: BytesLike): Result;
  ...
  events: {
    ...
    "DRTokenID(uint256,uint256,uint256,address,string,string,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "DRTokenID"): EventFragment;
...
export interface DRTokenIDEventObject {
  timestamp: BigNumber;
  id: BigNumber;
...
export type DRTokenIDEvent = TypedEvent<
  [BigNumber, BigNumber, BigNumber, string, string, string, BigNumber],
  DRTokenIDEventObject
>;

export type DRTokenIDEventFilter = TypedEventFilter<DRTokenIDEvent>;
...
export interface DR extends BaseContract {
  ...
  filters: {
    ...
    "DRTokenID(uint256,uint256,uint256,address,string,string,uint256)"(
      timestamp?: null,
